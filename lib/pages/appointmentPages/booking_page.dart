                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: _currentTimeIndex == index ? Colors.teal : Colors.black,
                        ),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                children: [
                  ElevatedButton(
                    onPressed: _dateSelected && _timeSelected ? sendRequest : null,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PaymentPage(appointmentId: null,),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
  ...
  Future<void> _fetchAvailableDates(DateTime start, DateTime end) async {
    ...
    try {
      ...
      for (var entry in response) {
        ...
        final dateList = List<Map<String, dynamic>>.from(availability['dates'] ?? []);
