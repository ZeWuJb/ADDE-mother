                              ...
                              child: Row(
                                ...
                                children: [
                                  CircleAvatar(
                                    radius: 18,
                                    backgroundColor: Theme.of(context).colorScheme.secondary,
                                    child: Text(comment.fullName.isNotEmpty ? comment.fullName[0] : '?'),
                                  ),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                comment.fullName.isNotEmpty ? comment.fullName : 'Unknown',
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        icon: const Icon(Icons.send, color: Color(0xFFf7a1c4)),
